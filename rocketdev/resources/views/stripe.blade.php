      ...
      <div class="container">
         <div class="row">
          <h3 style="text-align: center;margin-top: 40px;margin-bottom: 40px;">Laravel 9 Stripe Payment Gateway Integration - Techsolutionstuff</h3>
            <div class="col-md-12 col-md-6 col-md-offset-3 d-flex justify-content-center align-items-center ">
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                      ...
                      <input type="hidden" name="inscription" value="{{ json_encode($inscription) }}">
                      <input type="hidden" name="idinscri" value="{{ $idinscri }}">
                        <div class="form-row row">
                           <div class="col-md-12 ">
