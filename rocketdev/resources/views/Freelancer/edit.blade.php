        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <!-- General Form Elements -->
                <form method="post" action="{{route('Freelancer.update',['freelancer' => $freelancer])}}">
                    @csrf
                    @method('put')
                  <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Nom</label>
                    <div class="col-sm-10">
                      <input type="text" name="nom" class="form-control" value="{{$freelancer->nom}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="prenom" class="form-control" value="{{$freelancer->prenom}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="specialite" class="form-control" value="{{$freelancer->specialite}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="disponibilite" class="form-control" value="{{$freelancer->disponibilite}}">
                    </div>
                  </div>
