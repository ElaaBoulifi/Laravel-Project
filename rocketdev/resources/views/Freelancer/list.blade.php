                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form style="float: left" method="POST" action="{{route('Freelancer.delete',['freelancer'=>$item])}}">
                                                      @csrf
                                                      @method('delete')
                                                        <button type="submit" value="" class="btn btn-danger delete-item">
                                                          <i class="bi bi-trash"></i>

                                                        </button>
                                                    </form>
                                                    <a type="button" href="{{route('Freelancer.edit',['freelancer'=>$item])}}"
                                                        class="btn btn-primary"><i class="bi bi-folder"></i></a>
                                                </td>
